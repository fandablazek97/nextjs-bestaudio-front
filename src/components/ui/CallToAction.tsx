  ...
  return (
    <Link href={href} passHref legacyBehavior>
      <a
        ...
        {...rest}
      >
        <div className="absolute inset-0 -z-10 h-full w-full rounded-xl bg-gradient-to-r from-primary-active to-primary transition-transform duration-500 ease-in-out group-hover:scale-[0.92]" />
